define("NavYandexMapDetail", ["jQuery", "css!NavYandexMarkerCss"], function () {

    function createMarkerSvg(text, textColor, moving) {
...
`;
                        ...
                        listItems[0].onclick = function () {
                            ...
                            marker.icon.url = createMarkerSvg(marker.displayText, marker.textColor, true);
                            marker.map_changed();
                            marker.addListener("dragend", function (event) {
                                marker.setDraggable(false);
                                marker.icon.url = createMarkerSvg(marker.displayText, marker.textColor, false);
                                marker.map_changed();
                ...
                markers.each(function (item) {
                    ...
                    var image = createMarkerSvg(title);
                            ...
                            urlPromise.then(function (url) {
                                ...
                                if (url) {
                                    if (isLinkVisited(url)) {
                                        marker.icon.url = createMarkerSvg(title, "coral");
